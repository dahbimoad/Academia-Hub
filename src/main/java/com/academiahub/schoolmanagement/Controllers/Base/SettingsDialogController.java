...
private void handleEditProfile() {
    try {
        ...
        URL fxmlUrl = getClass().getResource("/com/academiahub/schoolmanagement/Views/Base/EditProfileDialog.fxml");
        if (fxmlUrl == null) {
...
private void handleChangePassword() {
    try {
        URL fxmlUrl = getClass().getResource("/com/academiahub/schoolmanagement/Views/Base/ChangePasswordDialog.fxml");
        if (fxmlUrl == null) {
